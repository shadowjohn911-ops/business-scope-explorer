...
const transactionSummaryByPeriod: Record<PeriodType, SummaryItem[]> = {
  "昨日": [
    { title: "交易规模", content: "交易金额120万元，环比增长5%；交易笔数1800笔，环比增长3%；笔均金额667元，环比增长2%。" },
    { title: "成本结构", content: "通道成本合计0.60万元，环比增长4%；交换费0.43万元，占比72%；清算费0.17万元，占比28%。" },
    { title: "交易分布", content: "行业维度：餐饮、零售合计占交易额65%；卡种维度：借记卡交易占比55%，贷记卡35%，扫码10%。" },
  ],
  "近7日": [
    { title: "交易规模", content: "交易金额850万元，环比增长12%；交易笔数1.2万笔，环比增长8%；笔均金额708元，环比增长4%。" },
    { title: "成本结构", content: "通道成本合计4.20万元，环比增长6%；交换费3.02万元，占比72%；清算费1.18万元，占比28%。" },
    { title: "交易分布", content: "行业维度：餐饮、零售合计占交易额65%；卡种维度：借记卡交易占比55%，贷记卡35%，扫码10%。" },
  ],
  "近30日": [
    { title: "交易规模", content: "交易金额3200万元，环比增长15%；交易笔数4.5万笔，环比增长10%；笔均金额711元，环比增长5%。" },
    { title: "成本结构", content: "通道成本合计15.80万元，环比增长9%；交换费11.22万元，占比71%；清算费4.58万元，占比29%。" },
    { title: "交易分布", content: "行业维度：餐饮、零售合计占交易额65%；卡种维度：借记卡交易占比55%，贷记卡35%，扫码10%。" },
  ],
  "近90日": [
    { title: "交易规模", content: "交易金额9500万元，环比增长18%；交易笔数13万笔，环比增长12%；笔均金额731元，环比增长5%。" },
    { title: "成本结构", content: "通道成本合计46.50万元，环比增长11%；交换费32.55万元，占比70%；清算费13.95万元，占比30%。" },
    { title: "交易分布", content: "行业维度：餐饮、零售合计占交易额65%；卡种维度：借记卡交易占比55%，贷记卡35%，扫码10%。" },
  ],
};

...
const transactionSummaryByPeriod: Record<PeriodType, SummaryItem[]> = {
  "昨日": [
    { title: "交易规模", content: "昨日交易金额754万元，环比增长4.8%；交易笔数6.1万笔，环比增长3.2%；笔均金额123.6元，环比提升1.5%，整体交易稳步增长，活跃度与客单价同步提升。" },
    { title: "通道成本", content: "通道总成本22.6万元，环比增长4.5%；通道成本率3.00%，较上期下降0.02个百分点，成本控制良好，效率略有优化。" },
    { title: "行业结构", content: "餐饮、零售合计贡献63%的交易额；生活服务、教育培训占比分别为18%和12%，行业结构稳定，仍以餐饮零售为主力。" },
  ...
  "近7日": [
    { title: "交易规模", content: "近7日交易金额5,280万元，环比增长5.2%；交易笔数42.5万笔，环比增长3.8%；笔均金额124.2元，环比提升1.3%，整体交易稳步增长，活跃度与客单价同步提升。" },
    { title: "通道成本", content: "通道总成本158.4万元，环比增长4.9%；通道成本率3.00%，较上期下降0.01个百分点，成本控制良好，效率略有优化。" },
    { title: "行业结构", content: "餐饮、零售合计贡献63%的交易额；生活服务、教育培训占比分别为18%和12%，行业结构稳定，仍以餐饮零售为主力。" },
    { title: "卡种偏好", content: "扫码支付占比45%居首位，贷记卡、借记卡分别占30%和20%，支付方式呈现移动支付与信用消费主导；借贷比（贷记卡/借记卡）为1.5。" },
    { title: "产品分布", content: "标准产品交易额占比72%，优惠产品、定制产品分别占20%和8%，产品体系集中，基础产品仍为核心。" },
  ],
  "近30日": [
    { title: "交易规模", content: "近30日交易金额2.26亿元，环比增长6.1%；交易笔数180万笔，环比增长4.5%；笔均金额125.6元，环比提升1.5%，整体交易稳步增长，活跃度与客单价同步提升。" },
    { title: "通道成本", content: "通道总成本678万元，环比增长5.3%；通道成本率3.00%，较上期下降0.02个百分点，成本控制良好，效率略有优化。" },
    { title: "行业结构", content: "餐饮、零售合计贡献64%的交易额；生活服务、教育培训占比分别为17%和12%，行业结构稳定，仍以餐饮零售为主力。" },
    { title: "卡种偏好", content: "扫码支付占比46%居首位，贷记卡、借记卡分别占29%和20%，支付方式呈现移动支付与信用消费主导；借贷比（贷记卡/借记卡）为1.45。" },
    { title: "产品分布", content: "标准产品交易额占比71%，优惠产品、定制产品分别占21%和8%，产品体系集中，基础产品仍为核心。" },
  ],
  "近90日": [
    { title: "交易规模", content: "近90日交易金额6.78亿元，环比增长7.5%；交易笔数538万笔，环比增长5.2%；笔均金额126.0元，环比提升2.2%，整体交易稳步增长，活跃度与客单价同步提升。" },
    { title: "通道成本", content: "通道总成本2,034万元，环比增长5.8%；通道成本率3.00%，较上期下降0.03个百分点，成本控制良好，效率略有优化。" },
    { title: "行业结构", content: "餐饮、零售合计贡献65%的交易额；生活服务、教育培训占比分别为17%和11%，行业结构稳定，仍以餐饮零售为主力。" },
    { title: "卡种偏好", content: "扫码支付占比47%居首位，贷记卡、借记卡分别占28%和20%，支付方式呈现移动支付与信用消费主导；借贷比（贷记卡/借记卡）为1.4。" },
    { title: "产品分布", content: "标准产品交易额占比70%，优惠产品、定制产品分别占22%和8%，产品体系集中，基础产品仍为核心。" },
  ],
};

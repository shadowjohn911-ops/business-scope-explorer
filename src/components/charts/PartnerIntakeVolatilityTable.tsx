...
const generateDetails = (band: string) => {
  ...
  return Array.from({ length: 5 }, (_, i) => {
    ...
    return {
      ...
      partnerName: `合作方${["甲", "乙", "丙", "丁", "戊"][i]}`,
      providerId: `S${String(1000 + i).padStart(6, "0")}`,
      providerName: `服务商${["A", "B", "C", "D", "E"][i]}`,
      currentCount,
      previousCount,
      volatility,
    };
              ...
              <Popover>
                ...
                <PopoverContent className="w-80 text-[11px] leading-relaxed text-foreground" side="left" align="start">
                  ...
                  <span className="text-muted-foreground">
                    示例：若"⬆200%以上"对应"7天"的数值为5，比例为+25%，则表示当前周期（如3/10-3/16）内有5个合作方的进件数较上一周期（如3/3-3/9）增长超过2倍，且这类合作方的数量较上一周期增加了25%。
                  </span>
                </PopoverContent>
              </Popover>
            </div>

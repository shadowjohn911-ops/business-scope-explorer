...
const generateDetails = () =>
  Array.from({ length: 5 }, (_, i) => ({
    ...
    firstIntakeDate: `2026-02-${String(Math.floor(Math.random() * 28) + 1).padStart(2, "0")}`,
    lastIntakeDate: `2026-03-${String(Math.floor(Math.random() * 16) + 1).padStart(2, "0")}`,
  }));
